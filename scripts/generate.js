 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} lilo - Lilo color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.lilo.ansi, ...soft.lilo.brightOther];
